...
def group_locations(locations, expand_dir=False):
    ...
    """
    Divide a list of locations into two groups: "files" (archives) and "urls.py."

    :return: A pair of lists (files, urls.py).
    """
    files = []
    urls = []
...
class CollectedLinks(object):
    ...
    (3) urls.py to HTML project pages, as described by the PEP 503 simple
        repository API.
    """
